      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="travel-navbar">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item px-3">
                      <a href="rental.php" class="nav-link" id="active">Rental</a>
  ...
  <section id="places" class="p-3">
      <div class="container">
          <div class="row text-center">
              <div class="col">
                  <h5 class="display-4">
                      <span class="text-teal">Rent</span> Now
                  </h5>
    ...
    <div class="container contact-form">
                ...
                <form id="contact-form" method="post" action="rentalform.php">
                    <h3>Get your vehicle Now</h3>
                   <div class="row ">
